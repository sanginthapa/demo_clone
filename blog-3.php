                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="blog-3.php" class="active">Blog Classic View</a></li>
    ...
    <div class="pageheader">
        <div class="container">
            <div class="pageheader__content">
                <h2>Recent Blogs Classic View</h2>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">classic View</li>
                    </ol>
                </nav>
            </div>
        </div>
                        ...
                        <div class="row g-4 justify-content-center">
                                ...
                                <div class="blog__item">
                                    <div class="blog__inner">
                                        <div class="blog__thumb">
                                            <a href="blog-single.php"><img src="assets/images/blog/01.jpg" alt="rajibraj" /></a>
                                            <span class="date"><i class="fa-solid fa-calendar-days"></i> 21 april 2022</span>
                                        </div>
                                        <div class="blog__content">
                                            <h3><a href="blog-single.php">Tips for Achieving Success in Your Business</a></h3>
                                            ...
                                            <p>Credibse syndicate vertical services wherea unique human capital Continue cultivat extent rather than stand alone process and cultivat virtual customer service throuigh profesional intellectual leverage awesome business existing.</p>
                                            <a href="blog-single.php" class="read-more">Continue Reading....</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="blog__item">
                                    <div class="blog__inner">
                                        <div class="blog__thumb">
                                            <a href="blog-single.php"><img src="assets/images/blog/02.jpg" alt="rajibraj" /></a>
                                            <span class="date"><i class="fa-solid fa-calendar-days"></i> 21 april 2022</span>
                                        </div>
                                        <div class="blog__content">
                                            <h3><a href="blog-single.php">Changing & Grow Business Faster and Better</a></h3>
                                            <div class="blog__meta">
                                                <ul>
                                                    <li><i class="fa-solid fa-user"></i> Admin</li>
                                                    <li><i class="fa-solid fa-message"></i> Comments  (3)</li>
                            ...
                            <div class="col-12">
                                <div class="blog__item">
                                    <div class="blog__inner">
                                        <div class="blog__thumb">
                                            <a href="blog-single.php"><img src="assets/images/blog/03.jpg" alt="rajibraj" /></a>
                                            <span class="date"><i class="fa-solid fa-calendar-days"></i> 21 april 2022</span>
                                        </div>
                                        <div class="blog__content">
                                            <h3><a href="blog-single.php">Changing & Grow Business Faster and Better</a></h3>
