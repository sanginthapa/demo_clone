                                    ...
                                    <div class="service__content">
                                        ...
                                        <div class="row g-4 mb-4">
                                            <div class="col-sm-6 col-12">
                                                <ul>
                                                    <li><i class="fa-solid fa-circle-check"></i> They choose Us because believe us</li>
                                                    <li><i class="fa-solid fa-circle-check"></i> We believe in the value of business</li>
                                                    <li><i class="fa-solid fa-circle-check"></i> Experienced Consey employees</li>
                                                    <li><i class="fa-solid fa-circle-check"></i> Easy way to train employees</li>
                                                    <li><i class="fa-solid fa-circle-check"></i> Our employees are professional</li>
                                                    <li><i class="fa-solid fa-circle-check"></i> We have great support marketing</li>
                                                </ul>
                                            </div>
                                            <div class="col-sm-6 col-12">
                                                <img src="assets/images/service/single/02.jpg" alt="rajibraj" class="w-100">
                                            </div>
                                        </div>
                                        <h4>Right People of A Fund Adviser</h4>
                                        <p>Our consultants believe in the value that you manage your regulatory compliance policies proced we have specialist for managed employee performance ands comparable internal advice function train people quickly well with e-business so they highly efficient manufactured products we are feel that this special functions is part of the success business.</p>
                                        <div class="feature feature__two py-4">
                                            <div class="section__wrapper">
                                                        ...
                                                        <div class="feature__item">
                                                            <div class="feature__inner">
                                                                ...
                                                                <div class="feature__content">
                                                                    ...
                                                                    <p>We have best consult and experienced adviser</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <p>Our consultants believe in the value that you manage your regulatory compliance policies proced we have specialist for managed employee performance ands comparable internal advice function train people quickly well with e-business so they highly efficient manufactured products we are feel that this special functions is part of the success business.</p>
                                        <div class="teamMember teamMember__two py-4">
                                            <div class="row g-4 justify-content-center">
                                    ...
                                    <div class="sidebar__service">
                                        ...
                                        <div class="body">
                                            <ul>
                                                <li>
                                                    <div class="thumb">
                                                        <a href="service-single.php"><img src="assets/images/service/icon/01.png" alt="rajibraj"></a>
                                                    </div>
                                                    <div class="content">
                                                        <span>Consulting</span>
                                                        <h5><a href="service-single.php">Business Consulting</a></h5>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="thumb">
                                                        <a href="service-single.php"><img src="assets/images/service/icon/02.png" alt="rajibraj"></a>
                                                    </div>
                                                    <div class="content">
                                                        <span>Marketing</span>
                                                        <h5><a href="service-single.php">Marketing Research</a></h5>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="thumb">
                                                        <a href="service-single.php"><img src="assets/images/service/icon/03.png" alt="rajibraj"></a>
                                                    </div>
                                                    <div class="content">
                                                        <span>Financial</span>
                                                        <h5><a href="service-single.php">Financial Planning</a></h5>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="thumb">
                                                        <a href="service-single.php"><img src="assets/images/service/icon/04.png" alt="rajibraj"></a>
                                                    </div>
                                                    <div class="content">
                                                        <span>Insurance</span>
                                                        <h5><a href="service-single.php">Insurance Consulting</a></h5>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="thumb">
                                                        <a href="service-single.php"><img src="assets/images/service/icon/05.png" alt="rajibraj"></a>
                                                    </div>
                                                    <div class="content">
                                                        <span>business</span>
                                                        <h5><a href="service-single.php">Retirement Planning</a></h5>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="thumb">
                                                        <a href="service-single.php"><img src="assets/images/service/icon/06.png" alt="rajibraj"></a>
                                                    </div>
                                                    <div class="content">
                                                        <span>Analyzing</span>
                                                        <h5><a href="service-single.php">Portfolio Management</a></h5>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
