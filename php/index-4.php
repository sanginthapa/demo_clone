...
<body>
                            ...
                            <ul>
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="index-4.php" class="active">Home Four</a></li>
    ...
    <div class="banner__slider__two overflow-hidden">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="banner banner__one banner__four bg-img overflow-hidden" style="background-image: url(assets/images/banner/bg/04.jpg);">
                    <div class="container">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-12">
                                    <div class="banner__content">
                                        ...
                                        <h2>lets experience be your guide</h2>
            ...
            <div class="swiper-slide">
                <div class="banner banner__one banner__four bg-img overflow-hidden" style="background-image: url(assets/images/banner/bg/04-d2.jpg);">
                    <div class="container">
                        <div class="banner__area">
                            <div class="row justify-content-center">
                                <div class="col-lg-6 col-12">
                                    <div class="banner__content text-sm-center">
                                        <h6>innovative business solution</h6>
                                        <h2>State of the art human capital.</h2>
                                        <div class="banner__btngroup justify-content-sm-center">
                                            <a href="#" class="lab-btn">view all services</a>
                                            <a href="https://www.youtube.com/embed/YjhrligRTbE" data-rel="lightcase" class="video__btn">
                                                <i class="fa-solid fa-circle-play"></i>
                                                <span>How we work</span>
            ...
            <div class="swiper-slide">
                <div class="banner banner__one banner__four bg-img overflow-hidden" style="background-image: url(assets/images/banner/bg/04-d3.jpg);">
                    <div class="container">
                        <div class="banner__area">
                            <div class="row">
                ...
                <div class="swiper-wrapper">
                        ...
                        <div class="feature__item">
                            <div class="feature__inner">
                                <div class="feature__thumb">
                                    <img src="assets/images/feature/icon/11.png" alt="feature icon" />
                                </div>
                                <div class="feature__content">
                                    <h5>Best advisory Training</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="feature__item">
                            <div class="feature__inner">
                                <div class="feature__thumb">
                                    <img src="assets/images/feature/icon/12.png" alt="feature icon" />
                                </div>
                                <div class="feature__content">
                    ...
                    <div class="swiper-slide">
                        <div class="feature__item">
                            <div class="feature__inner">
                                <div class="feature__thumb">
                                    <img src="assets/images/feature/icon/13.png" alt="feature icon" />
                                </div>
                                <div class="feature__content">
                                    <h5>Resourcing & Talent</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="feature__item">
                            <div class="feature__inner">
                                <div class="feature__thumb">
                                    <img src="assets/images/feature/icon/14.png" alt="feature icon" />
                                </div>
                                <div class="feature__content">
                                    <h5>Performance Develop</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="feature__item">
                            <div class="feature__inner">
                                <div class="feature__thumb">
                                    <img src="assets/images/feature/icon/15.png" alt="feature icon" />
                                </div>
                                <div class="feature__content">
                                    <h5>Communicate key skills</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="feature__item">
                            <div class="feature__inner">
                                <div class="feature__thumb">
                                    <img src="assets/images/feature/icon/16.png" alt="feature icon" />
                                </div>
                                <div class="feature__content">
    ...
    <div class="about about__three padding-tb">
        <div class="container">
            <div class="row g-5 flex-row-reverse">
                <div class="col-lg-6 col-12 ps-lg-4">
                    <div class="about__content">
                        <h6>See the difference</h6>
                        <h2>Do you need help for yourself or a loved one?</h2>
                        <p>We are proud to offer top ranige in employment services such and asser payroll and benefits administrato managemen and asistance with global business range employment employer compliance.</p>
                        <ul>
                            <li>
                                <div class="icon">
                                ...
                                <div class="text">
                                    ...
                                    <p>Strategy experienc and ana lytical expertise.</p>
                                </div>
                            </li>
                            <li>
                                <div class="icon">
                                    <img src="assets/images/about/icon/05.png" alt="about icon" />
                                </div>
                                <div class="text">
                                    <h6>Our Resources</h6>
                                    <p>Strategy experienc and ana lytical expertise.</p>
                ...
                <div class="col-lg-6 col-12">
                    <div class="about__thumb">
                        <div class="row g-4">
                            <div class="col-12">
                                <div class="thumb">
                                    <img src="assets/images/about/08.jpg" alt="about" class="w-100" />
                            ...
                            <div class="col-sm-6 col-12">
                                <div class="thumb">
                                    <img src="assets/images/about/09.jpg" alt="about" class="w-100" />
                                </div>
                            </div>
                            <div class="col-sm-6 col-12">
                                <div class="thumb">
                                    <img src="assets/images/about/10.jpg" alt="about" class="w-100" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="service__item">
                            <div class="service__inner">
                                ...
                                <div class="service__content">
                                    ...
                                    <a href="service-single.php" class="read-more">read more</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="specialtie specialtie__two padding-tb">
        <div class="container">
            <div class="section__wrapper">
                <div class="row g-4 justify-content-center">
                    <div class="col-12">
                        <div class="specialtie__item">
                            <div class="specialtie__inner">
                                <div class="specialtie__thumb">
                                    <img src="assets/images/specialtie/01.jpg" alt="rajibraj" class="w-100" />
                                </div>
                                <div class="specialtie__content">
                                    <h6>See the diffrence</h6>
                                    <h2>With our specialists, and expert at your disposal.</h2>
                                    <p>We have introducing the proper human resources, which will managed and created by our company’s employees.</p>
                                    <div class="row g-4 mt-4">
                                        <div class="col-sm-6 col-12">
                                            <div class="thumb">
                                                <img src="assets/images/specialtie/02.jpg" alt="rajibraj" />
                                                <a href="https://www.youtube.com/embed/YjhrligRTbE" data-rel="lightcase" class="icon"><i class="fa-solid fa-play"></i></a>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-12">
                                            <div class="content">
                                                <ul>
                                                    <li><i class="fa-solid fa-circle-check"></i> High standards of integrity.</li>
                                                    <li><i class="fa-solid fa-circle-check"></i> Give our best. Abilitylearn.</li>
                                                    <li><i class="fa-solid fa-circle-check"></i> We do not have to be.</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="work bg-color padding-tb">
        <div class="container">
            <div class="section__header text-center">
                <h6>How We Work</h6>
