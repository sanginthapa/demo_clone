...
<body>
                ...
                <div class="header__toparea">
                    ...
                    <div class="info">
                        <ul>
                            <li>
                                <div class="thumb">
                                    <img src="assets/images/header/icon/03.png" alt="icon" />
                                </div>
                                <div class="text">
                            ...
                            <li>
                                <div class="thumb">
                                    <img src="assets/images/header/icon/04.png" alt="icon" />
                                </div>
                                <div class="text">
                                    <span>Call us</span>
                            ...
                            <li>
                                <div class="thumb">
                                    <img src="assets/images/header/icon/05.png" alt="icon" />
                                </div>
                                <div class="text">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="index-2.php" class="active">Home Two</a></li>
    ...
    <div class="banner__slider overflow-hidden">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="banner banner__two bg-img" style="background-image: url(assets/images/banner/bg/02.jpg);">
                    <div class="container">
                            ...
                            <div class="row">
                                <div class="col-lg-7 col-12">
                                    <div class="banner__content">
                                        ...
                                        <h2>Start your journey better business</h2>
            ...
            <div class="swiper-slide">
                <div class="banner banner__two bg-img bpc" style="background-image: url(assets/images/banner/bg/03.jpg);">
                    <div class="container">
                        <div class="banner__area">
    ...
    <div class="feature feature__two padding-tb">
        <div class="container">
            <div class="section__header text-center">
                <h6>Our approach</h6>
                <h2>Get Most Advantage Solution For Your Business</h2>
            </div>
            <div class="section__wrapper">
                <div class="row g-4 justify-content-center">
                        ...
                        <div class="feature__item">
                            <div class="feature__inner">
                                <div class="feature__thumb">
                                    <img src="assets/images/feature/icon/04.png" alt="feature icon" />
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                        <div class="feature__item">
                            <div class="feature__inner">
                                <div class="feature__thumb">
                                    <img src="assets/images/feature/icon/05.png" alt="feature icon" />
                                </div>
                                <div class="feature__content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                        <div class="feature__item">
                            <div class="feature__inner">
                                <div class="feature__thumb">
                                    <img src="assets/images/feature/icon/06.png" alt="feature icon" />
                                </div>
                                <div class="feature__content">
                                    <h4>Our Strategy</h4>
                                    <p>Any other hand we denoue with rghteou ndignaon and the dislike men</p>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                        <div class="feature__item">
                            <div class="feature__inner">
                                <div class="feature__thumb">
                                    <img src="assets/images/feature/icon/07.png" alt="feature icon" />
                                </div>
                                <div class="feature__content">
                                    <h4>Our Strategy</h4>
                                    <p>Any other hand we denoue with rghteou ndignaon and the dislike men</p>
                ...
                <div class="text-center mt-5 infotext">
                    <p>Get interest about our  service function? <a href="#">Learn More</a></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="about about__one padding-tb bg-color">
        <div class="container">
            <div class="row g-5 flex-row-reverse align-items-end">
                <div class="col-lg-6 col-12 ps-lg-4">
                    <div class="about__content">
                        <h6>How to grow business</h6>
                        <h2>We help young companies to expand business</h2>
                        <p>We are proud to offer top rangen comprehensve employmen services such and aser payroll & benefts adminitration management asstance with global business range employment employer compliance.</p>
                        <p>We are proud to offer top rangen comprehensve employmen services such and aser payroll & benefts adminitration management asstance with global business range employment employer compliance.</p>
                        <ul>
                            <li class="w-100">
                                <div class="icon">
                                ...
                                <div class="text">
                                    ...
                                    <p>Our strategc partner are that specials roles of advsor to our  success business.</p>
                                </div>
                            </li>
                            <li class="w-100">
                                <div class="icon">
                                ...
                                <div class="text">
                                    <h6>Corporate Program</h6>
                                    <p>Corporates programs are add bests advsers function to our success business.</p>
                                </div>
                            </li>
                        </ul>
                        <div class="about__footer">
                            <a href="appointment.php" class="lab-btn">Book a consultation</a>
                            <div class="about__author">
                                <div class="thumb">
                                    <img src="assets/images/about/author/01.jpg" alt="about author" />
                                </div>
                                <div class="content">
                                    <h6><a href="adviser-single.php">Amanda Berry</a></h6>
                                    <span>Founder</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="about__thumb">
                        <div class="row g-4">
                            <div class="thumb thumb--2 text-end">
                                <img src="assets/images/about/04.jpg" alt="About Image" />
                                <div class="thumb--experience text-start">
                                    <img src="assets/images/about/icon/03.png" alt="Icon" />
                                    <h5>We're ready to <br /> assist you</h5>
                                </div>
                                <div class="floating-img"><img src="assets/images/about/05.jpg" alt="About Image" /></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="section__wrapper">
                            ...
                            <div class="pp-fornt">
                                <div class="service__inner text-center">
                                    ...
                                    <div class="service__content">
                                        ...
                                        <h4><a href="service-single.php">Business Consulting</a></h4>
                                        <p>We are provide best service for high level success your business</p>
                                        <a href="service-single.php" class="read-more">more details</a>
                                    </div>
                                </div>
                            </div>
                            <div class="pp-back" style="background-image: url(assets/images/project/01.jpg);">
                                <a href="service-single.php" class="lab-btn">more details</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="service__item position-relative">
                            <div class="pp-fornt">
                                <div class="service__inner text-center">
                                    ...
                                    <div class="service__content">
                                        <span>Marketing</span>
                                        <h4><a href="service-single.php">Marketing Research</a></h4>
                                        <p>We are provide best service for high level success your business</p>
                                        <a href="service-single.php" class="read-more">more details</a>
                                    </div>
                                </div>
                        ...
                        <div class="service__item position-relative">
                            <div class="pp-fornt">
                                <div class="service__inner text-center">
                                    ...
                                    <div class="service__content">
                                        <span>Financial</span>
                                        <h4><a href="service-single.php">Financial Planning</a></h4>
                                        <p>We are provide best service for high level success your business</p>
                                        <a href="service-single.php" class="read-more">more details</a>
                                    </div>
                                </div>
                        ...
                        <div class="service__item position-relative">
                            <div class="pp-fornt">
                                <div class="service__inner text-center">
                                    ...
                                    <div class="service__content">
                                        <span>financial</span>
                                        <h4><a href="service-single.php">Insurance Consulting</a></h4>
                                        <p>We are provide best service for high level success your business</p>
                                        <a href="service-single.php" class="read-more">more details</a>
                                    </div>
                                </div>
                        ...
                        <div class="service__item position-relative">
                            <div class="pp-fornt">
                                <div class="service__inner text-center">
                                    ...
                                    <div class="service__content">
                                        <span>business</span>
                                        <h4><a href="service-single.php">Retirement Planning</a></h4>
                                        <p>We are provide best service for high level success your business</p>
                                        <a href="service-single.php" class="read-more">more details</a>
                                    </div>
                                </div>
                        ...
                        <div class="service__item position-relative">
                            <div class="pp-fornt">
                                <div class="service__inner text-center">
                                    ...
                                    <div class="service__content">
                                        <span>Analyzing</span>
                                        <h4><a href="service-single.php">Portfolio Management</a></h4>
                                        <p>We are provide best service for high level success your business</p>
                                        <a href="service-single.php" class="read-more">more details</a>
                                    </div>
                                </div>
                ...
                <div class="text-center infotext">
                    <p>Get the Financial Outsourcing Service’s. <a href="appointment.php">Book an appointment!</a></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="teamMember teamMember__two padding-tb">
        <div class="container">
            ...
            <div class="section__wrapper">
                <div class="row g-4 justify-content-center">
                        ...
                        <div class="teamMember__item">
                            <div class="teamMember__inner">
                                <div class="teamMember__thumb">
                                    <a href="adviser-single.php"><img src="assets/images/team/01.jpg" alt="teamMember" /></a>
                                </div>
                                <div class="teamMember__content">
                                    <h4><a href="adviser-single.php">Harry Abraham</a></h4>
                                    <span>founder</span>
                                    <ul>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                        <div class="teamMember__item">
                            <div class="teamMember__inner">
                                <div class="teamMember__thumb">
                                    <a href="adviser-single.php"><img src="assets/images/team/02.jpg" alt="teamMember" /></a>
                                </div>
                                <div class="teamMember__content">
                                    <h4><a href="adviser-single.php">Thomas Novak</a></h4>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                        <div class="teamMember__item">
                            <div class="teamMember__inner">
                                <div class="teamMember__thumb">
                                    <a href="adviser-single.php"><img src="assets/images/team/03.jpg" alt="teamMember" /></a>
                                </div>
                                <div class="teamMember__content">
                                    <h4><a href="adviser-single.php">Edward Willey</a></h4>
                                    <span>Merketer</span>
                                    <ul>
                                        <li><a href="#"><i class="fa-brands fa-facebook-f"></i></a></li>
                                        <li><a href="#"><i class="fa-solid fa-rss"></i></a></li>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                        <div class="teamMember__item">
                            <div class="teamMember__inner">
                                <div class="teamMember__thumb">
                                    <a href="adviser-single.php"><img src="assets/images/team/04.jpg" alt="teamMember" /></a>
                                </div>
                                <div class="teamMember__content">
                                    <h4><a href="adviser-single.php">mr Berry Castle</a></h4>
                                    <span>Advisor</span>
                                    <ul>
                                        <li><a href="#"><i class="fa-brands fa-facebook-f"></i></a></li>
                                        <li><a href="#"><i class="fa-solid fa-rss"></i></a></li>
                ...
                <div class="text-center infotext">
                    <p>Get the training from organizations best <a href="#">consultant’s</a></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="testimonial testimonial__two padding-tb bg-img" style="background-image: url(assets/images/bg/02.jpg);">
        <div class="container">
            <div class="section__header text-center">
    ...
    <div class="blog blog__two home padding-tb">
        <div class="container">
            <div class="section__header text-center">
                ...
                <div class="row g-4 justify-content-center">
                        ...
                        <div class="blog__item">
                            <div class="blog__inner">
                                <div class="blog__thumb">
                                    <a href="blog-single.php"><img src="assets/images/blog/home/01.jpg" alt="blog thumb" /></a>
                                    <span class="date"><i class="fa-solid fa-calendar-days"></i> 21 april 2022</span>
                                </div>
                                <div class="blog__content">
                                    <h4><a href="blog-single.php">tips Achieving Success in our Business</a></h4>
                    ...
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="blog__item">
                            <div class="blog__inner">
                                <div class="blog__thumb">
                                    <a href="blog-single.php"><img src="assets/images/blog/home/02.jpg" alt="blog thumb" /></a>
                                    <span class="date"><i class="fa-solid fa-calendar-days"></i> 23 april 2022</span>
                                </div>
                                <div class="blog__content">
                                    <h4><a href="blog-single.php">Changing Grow Business Faster and Better</a></h4>
                                    <div class="blog__meta">
                                        <ul>
                                            <li><i class="fa-solid fa-user"></i> Admin</li>
                    ...
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="blog__item">
                            <div class="blog__inner">
                                <div class="blog__thumb">
                                    <a href="blog-single.php"><img src="assets/images/blog/home/03.jpg" alt="blog thumb" /></a>
                                    <span class="date"><i class="fa-solid fa-calendar-days"></i> 25 april 2022</span>
                                </div>
                                <div class="blog__content">
                                    <h4><a href="blog-single.php">Employee development is company’s success</a></h4>
                                    <div class="blog__meta">
                                        <ul>
                                            <li><i class="fa-solid fa-user"></i> Admin</li>
