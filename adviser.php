...
<body>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <ul>
                                                <li><a href="adviser.php" class="active">adviser</a></li>
    ...
    <div class="callAaction padding-tb bg-img" style="background-image: url(assets/images/bg/06.jpg);">
        <div class="container">
            <div class="row g-4">
